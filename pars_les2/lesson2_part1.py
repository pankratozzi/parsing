...
def parse_hh(url, params, headers, num_pages=5):
    ...
    while params['page'] < num_pages:
        ...
        for idx, item in enumerate(vacancy_list):
            ...
            try:
                ...
                vacancies['Employee'] = item.find('a', attrs={'class': 'bloko-link_secondary'}).getText()
...
def parse_sjob(url, params, headers, num_pages=None):
